// ============================================================================
//  ATraderNPC — торговец.
//  Здесь я сделал NPC с зоной взаимодействия (InteractionSphere): когда игрок
//  входит в радиус, торговец «запоминается» в контроллере, появляется подсказка
//  [E] и можно открыть торговлю; торговец плавно поворачивается к игроку.
//  ЗАЩИТА (этап 7): открываю, когда показываю торговца и торговлю.
//  Главное: BeginPlay() — подключение обработчиков зоны; HandleInteractionSphere-
//  BeginOverlap/EndOverlap() — вход/выход игрока; Tick() — поворот к игроку.
// ============================================================================
