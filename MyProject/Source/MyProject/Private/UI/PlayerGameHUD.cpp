// ============================================================================
//  APlayerGameHUD — весь мой интерфейс, нарисованный вручную через Canvas.
//  Здесь я рисую стартовое меню, экран загрузки, паузу, настройки, торговлю,
//  прокачку, панели ресурсов/стамины/уровня и рабочие заказы, а также обрабаты-
//  ваю клики и прокрутку. Каждая кнопка/ползунок регистрируется в списке и
//  проверяется при клике (верхнее окно имеет приоритет).
//  ЗАЩИТА (этапы 1,2,6,7,8,9): открываю, когда показываю любой экран интерфейса.
//  Главное: DrawHUD() — выбор что рисовать; DrawMainMenu()/DrawSettingsPanel()/
//  DrawTradePanel()/DrawProgressionPanel(); HandleClick()/HandleScroll().
// ============================================================================
