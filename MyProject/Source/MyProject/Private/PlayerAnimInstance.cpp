// ============================================================================
//  UPlayerAnimInstance — связь персонажа с анимацией.
//  Каждый кадр я считаю из реальной скорости персонажа данные для Anim Blueprint:
//  скорость, направление, в воздухе ли, есть ли движение, идёт ли атака. Anim
//  Blueprint по этим значениям выбирает нужную анимацию (стоит/идёт/бежит/удар).
//  ЗАЩИТА (этапы 4,5): упоминаю, когда показываю движение и анимацию персонажа.
//  Главное: NativeUpdateAnimation() — расчёт Speed/Direction/bIsInAir/bIsAttacking.
// ============================================================================
