// ============================================================================
//  AGameplayCharacterBase — базовый класс моего персонажа.
//  Сюда я вынес всю игровую логику: стамину, удар киркой, ресурсы и золото,
//  опыт и прокачку, зелья и сохранение прогресса в JSON. Управляемые пешки
//  (AThifCatcher / Sandbox) наследуются отсюда — так логика не дублируется.
//  ЗАЩИТА (этапы 5,6,8): открываю этот файл, когда рассказываю про стамину/
//  спринт, добычу руды и прокачку.
//  Главное: Attack()/TryDamageOre() — удар и урон по руде; SetSprintActive() и
//  Decrease/IncreaseStamina() — стамина; AddExperience()/SpendUpgradePoint() —
//  прокачка; BeginPlay()/EndPlay() — загрузка/сохранение JSON.
// ============================================================================
