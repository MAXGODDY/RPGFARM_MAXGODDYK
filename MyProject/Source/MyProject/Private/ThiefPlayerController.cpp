// ============================================================================
//  AThiefPlayerController — мой контроллер игрока.
//  Отвечает за весь ввод, состояния меню, переходы между картами, настройки и
//  их сохранение, переназначение клавиш и язык. Логику меню я держу отдельно
//  от персонажа, чтобы не смешивать ввод и игровое поведение.
//  ЗАЩИТА (этапы 1,2,3,7): открываю, когда показываю меню/настройки, переход
//  лобби→Showcase и логику торговли.
//  Главное: StartGameplayFromMenu()/OpenGameplayMap() — запуск игры; Toggle*Menu()
//  — окна; ExecuteMenuOption()/HandleLeftClick() — действия кнопок; ApplyMenuInput-
//  State() — режим ввода; Load/SaveSettingsToJson() — настройки.
// ============================================================================
