...
//  Здесь я добавил камеру от третьего лица (SpringArm + Camera), ввод движения,
//  прыжок и спринт. Сама игровая логика (стамина, атака) — в базовом классе.
//  ЗАЩИТА (этап 4): открываю, когда показываю управление и камеру.
//  Главное: SetupPlayerInputComponent() — привязка клавиш; MoveForwardBackward()/
//  MoveRightLeft() — движение относительно камеры; Sprint()/StopSprint().
// ============================================================================
