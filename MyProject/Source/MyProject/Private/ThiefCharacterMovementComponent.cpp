// ============================================================================
//  UThiefCharacterMovementComponent — мой кастомный компонент движения.
//  Я сделал его, чтобы C++-логика стамины была главной: когда стамина на нуле,
//  скорость жёстко режется до ходьбы, что бы ни выставил Blueprint спринта.
//  ЗАЩИТА (этап 5): упоминаю, когда объясняю, почему на нуле стамины нельзя
//  бежать даже через Blueprint.
//  Главное: GetMaxSpeed() — лимит скорости при истощении; TickComponent() —
//  подрезает MaxWalkSpeed, чтобы анимация походки совпадала со скоростью.
// ============================================================================
