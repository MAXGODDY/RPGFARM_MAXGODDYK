// ============================================================================
//  AThiefCatcerGameMode — мой игровой режим.
//  Задаёт играемую пешку, контроллер и HUD. В лобби (NewMap) намеренно не
//  создаёт персонажа — там только меню. На игровой карте Showcase авто-спавнит
//  невидимый барьер мира, чтобы игрок не выпал за край.
//  ЗАЩИТА (этапы 1,11): упоминаю, когда показываю запуск из лобби и границы мира.
//  Главное: SpawnDefaultPawnFor_Implementation() — нет Pawn в лобби; BeginPlay()
//  — спавн барьера AWorldBoundaryWall по размерам ландшафта.
// ============================================================================
